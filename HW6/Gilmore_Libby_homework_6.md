...
- [Set-up](#set-up)
- [Section A. Can you improve this analysis
  code?](#section-a-can-you-improve-this-analysis-code)
  - [simplify to core working
    snippet](#simplify-to-core-working-snippet)
  - [Test function](#test-function)
- [Section B. Analysis of Protein Drug
  Interactions](#section-b-analysis-of-protein-drug-interactions)
...
![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-5-1.png)

``` r
plotb3(s2.b, sse=s2.chainA, typ="l", ylab="Bfactor") 
```

![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-5-2.png)

``` r
plotb3(s3.b, sse=s3.chainA, typ="l", ylab="Bfactor")
```

![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-5-3.png)
...
```
    ...
    /var/folders/01/t4pkq4h158zdt81cbt_86rbr0000gn/T//RtmpFPnamY/4AKE.pdb exists.
    Skipping download

      Note: Accessing on-line PDB file

    Warning in get.pdb(file, path = tempdir(), verbose = FALSE):
    /var/folders/01/t4pkq4h158zdt81cbt_86rbr0000gn/T//RtmpFPnamY/1AKE.pdb exists.
    Skipping download
    ...
    Warning in get.pdb(file, path = tempdir(), verbose = FALSE):
    /var/folders/01/t4pkq4h158zdt81cbt_86rbr0000gn/T//RtmpFPnamY/1E4Y.pdb exists.
    Skipping download
...
analyze_protein <- function(pdb, chain = "A", elety = "CA", plot = TRUE){
  ...
  # Extract only specified chain and Cα atoms
...
![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-10-1.png)
...
![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-10-2.png)
...
![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-12-1.png)

#### Q6.

How would you generalize the original code above to work with any set of
input protein structures? Write your own function starting from the code
above that analyzes protein drug interactions by reading in any protein
PDB data and outputs a plot for the specified protein.
...
![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-13-1.png)

``` r
plot(results$clustering, main = "B-factor Similarity Dendrogram")
```

![](Gilmore_Libby_homework_6_files/figure-commonmark/unnamed-chunk-13-2.png)
